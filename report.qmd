...
**\[PLACEHOLDER - need to describe the data structure needed for LMMs\]**
...
if (!requireNamespace(c("tidyverse", "lme4", "nlme", "gt", "RefManageR", "DataExplorer"), quietly = TRUE)) {
    install.packages(c("tidyverse", "lme4", "nlme", "gt", "RefManageR", "DataExplorer"))
}
...
# Iterate over each column and print outliers
