...
-   PlaceHolder for Bar Plots

## EDA - Numerical Variables {.smaller}

-   Placeholder for Histogram and QQ plots
...
-   Placeholder for countplot

## Linear Mixed Model Approach {.smaller}

-   Variable of interest (BMI) and controlled variables (fixed effects)

-   Random variability between individual observations (random effects)

-   Incorporation of random effects in the final model
